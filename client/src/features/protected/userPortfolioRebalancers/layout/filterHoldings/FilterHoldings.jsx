...
const FilterHoldings = ({
  ...
  const groupOptions = useMemo(() => {
    return Object.entries(userData?.groups || {}).flatMap(
      ([levelKey, groups]) =>
  ...
  const ShowReblancerButton = {
    id: "reblancer-filter-submit",
    text: isPending ? "Fetching..." : "View",
    varient: "buttonBlackSquare",
    type: "submit",
    disabled: isPending,
  };

  const CreateNewBlancerButton = {
    id: "reblancer-create-toggle",
    text: "Create New Rebalncer",
    varient: "buttonBlackSquare",
    type: "button",
  };
    ...
    <form
      ...
      <div className={filterHoldingsStyles.groupInputContainer}>
        ...
        <div className={filterHoldingsStyles.inputContainer}>
          ...
          <Button {...ShowReblancerButton} />
          <Button {...CreateNewBlancerButton} />
        </div>
      </div>
    </form>
  );
